...
if __name__=="__main__":
    ...
    model = PPO("MultiInputPolicy", env, policy_kwargs=policy_kwargs, verbose=1, n_steps=1024, batch_size=256, gamma=0.999, tensorboard_log="tensorboard/")
    ...
    model.save("/home/andrei/Desktop/THESIS_multi_task_policy_distilation/WORKING_folder_thesis/TRAINED_agents/Wrapped_right_10000steps")
