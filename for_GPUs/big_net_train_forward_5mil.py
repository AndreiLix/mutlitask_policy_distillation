...
class AntDirectionTaskWrapper(gym.Wrapper):
    def __init__(
        self,
        env: gym.Env,
        randomized_goal_directions=[[0,1]] # list of [dx, dy] vectors of goal directions.
...
if __name__=="__main__":
    ...
    model = PPO("MultiInputPolicy", env, policy_kwargs=policy_kwargs, verbose=1, n_steps=1024, batch_size=256, n_epochs=5, gamma=0.99, tensorboard_log="/home/u699081/FOLDER_thesis/checkpoints/big_net_ant_forward/tensorboard/")
    ...
    model.save("/home/u699081/FOLDER_thesis/checkpoints/ant_forward/big_net_ant_forward_model")
    env.save("/home/u699081/FOLDER_thesis/checkpoints/ant_forward/big_net_ant_forward_vecnormalize.pkl")
