...
if __name__=="__main__":
    ...
    model = PPO("MultiInputPolicy", env, policy_kwargs=policy_kwargs, verbose=1, n_steps=1024, batch_size=256, n_epochs=5, gamma=0.99, tensorboard_log="/home/u699081/FOLDER_thesis/checkpoints/ant_multitask/tensorboard/")
    ...
    model.save("/home/u699081/FOLDER_thesis/checkpoints/ant_multitask/ant_multitask_model")
    env.save("/home/u699081/FOLDER_thesis/checkpoints/ant_multitask/ant_multitask_vecnormalize.pkl")
